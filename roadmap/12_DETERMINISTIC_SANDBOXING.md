...
- [ ] **Tarea 1.2**: Desacoplamiento de Webhooks. Garantizar que los endpoints de entrada (`/chat`, `/workspace/hitl`, `/triage`) en `server.mjs` emitan HTTP `200 OK` en <50ms tras asentar en SQLite WAL, eliminando timeouts 504 de Telegram.
